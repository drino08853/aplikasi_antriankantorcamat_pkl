...
if (isset($_SERVER['REQUEST_METHOD']) && ($_SERVER['REQUEST_METHOD'] == 'POST' || $_SERVER['REQUEST_METHOD'] == 'GET')) {
    ...
    $query = mysqli_query($mysqli, "SELECT id, antrian FROM queue_penggilan_antrian ORDER BY id ASC") or die('Ada kesalahan pada query tampil data : ' . mysqli_error($mysqli));
